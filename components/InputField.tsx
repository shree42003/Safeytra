 ...
 <KeyboardAvoidingView behavior={Platform.OS === "ios"? "padding":"height" }>
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View>
            ...
            <View className ={`flec flex-row justify-start items-center relative bg-neutral-100 rounded-ful border border-neutral-100 focus:border-primary-500, ${containerStyle} `}>
